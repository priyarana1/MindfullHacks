...
Window         : 256 samples (1 representative second per 15-min epoch,
                 as generated by generate_eeg_csv.py).
                 Freq resolution = 1 Hz — sufficient for all EEG bands.
                 For a full continuous 256 Hz recording, set
                 SAMPLES_PER_WIN = FS * 900 (230,400) instead.
"""
...
SAMPLES_PER_WIN  = 256    # samples per epoch window (1 s at 256 Hz)
                          # Each window = one 15-minute slice of the day.
                          # Freq resolution: FS / SAMPLES_PER_WIN = 1 Hz.
                          # For a full continuous recording swap to:
                          #   SAMPLES_PER_WIN = FS * 15 * 60  (230,400)
